...
parser.add_argument('--source1', type=str, default='real', metavar='N',
...
print('source1 %s source2 %s target %s' % (args.source1, args.source2, args.target))
if args.cuda:
...
def main():
    ...
    solver = Solver(args, target=args.target, learning_rate=args.lr, batch_size=args.batch_size,
                    ...
                    checkpoint_dir=args.checkpoint_dir,save_epoch=args.save_epoch)
