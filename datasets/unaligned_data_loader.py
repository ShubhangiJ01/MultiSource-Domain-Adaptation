...
class UnalignedDataLoader():
    ...
    def initialize(self, source_loader1,source_loader2,target_loader,batch_size1,batch_size2,scale=32):
        print("SOURCE HERE")
        print(source_loader1)
        """
        ...
        #dataset_source1 = Dataset(source[0]['imgs'], source[0]['labels'], transform=transform)
        self.dataset_s1 = source_loader1
        ...
        self.dataset_s2 = source_loader2
        """
        ...
        self.dataset_t = target_loader

        #self.paired_data = PairedData(data_loader_s1, data_loader_s2, data_loader_s3,data_loader_s4, data_loader_t,float("inf"))
        self.paired_data = PairedData(source_loader1, source_loader2, target_loader,float("inf"))
